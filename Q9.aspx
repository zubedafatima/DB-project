<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Q9.aspx.cs" Inherits="projectDB.Q9" %>
...
<body >
        ...
        <div style="padding:10px;background-color:azure;width:1270px;align-content:center">
            <h1>Generated Report 9</h1>
        </div>
        <form id="form1" runat="server">
        <h2 style="padding:5px;"> Registration Details of Event:</h2>
