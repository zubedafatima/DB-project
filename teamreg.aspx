<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teamreg.aspx.cs" Inherits="projectDB.teamreg" %>
...
<%----<asp:DropDownList ID="Food3" runat="server"  Height="23px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="250px" style="margin-left:80px;border-radius:10px;border-color:#8dc9dd">
                            <asp:ListItem Text=" ..." Value="1" />
                           <asp:ListItem Text=" 1: One Day Meal" Value="1" />
                            <asp:ListItem Text=" 2: Two Days Meal"  Value="2" />
                           <asp:ListItem Text=" 3: Three Days Meal" Value="1" />
