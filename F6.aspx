<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="F6.aspx.cs" Inherits="projectDB.F6" %>
...
<body >
        ...
        <div style="padding:10px;background-color:azure;width:1270px;align-content:center">
            <h1>Generated Report 6</h1>
        </div>
    <form id="form2" runat="server">
        <h2 style="padding:5px;"> Event details (of your category) On The date:</h2>
