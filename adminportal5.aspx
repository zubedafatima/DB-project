<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminportal5.aspx.cs" Inherits="projectDB.adminportal5" %>
        ...
        <div class="dropdown" style="background-color:antiquewhite;width:50%;height:100%;float:left">
         ...
         <form id="form1" runat="server">
           ...
           <asp:Button ID="Button2" runat="server" Height="30px"  style="margin-left: 380px; margin-top: 50px; z-index: 1; left: -110px; top: 450px; position: absolute;" Text="Update" Width="86px" Font-Bold="True" ForeColor="#8dc9dd" border-color="#8dc9dd" />
             ...
             <asp:TextBox ID="category" runat="server" style="position: absolute;width: 40%;height: 4%; left: 29%; top: 330px; font-size: 1.3rem;border-radius: 10px;border-color:#8dc9dd">
            </asp:TextBox>
             <asp:TextBox ID="contact" runat="server" style="position: absolute;width: 40%;height: 4%; left: 29%; top: 410px; font-size: 1.3rem;border-radius: 10px;border-color:#8dc9dd">
            </asp:TextBox>
             <h2 style="margin-left:250px;font-family:'Arial Rounded MT';color:#9878a9">Admin ID</h2>
             <br />
             <br />
             <h2 style="margin-left:250px;font-family:'Arial Rounded MT';color:#9878a9">Admin Name</h2>
             <br />

            <h2 style="margin-left:250px;font-family:'Arial Rounded MT';color:#9878a9">Contact</h2>
             </form>
